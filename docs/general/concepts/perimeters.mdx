...
The amount of resources included in a [workspace](/docs/general/concepts/workspaces) can be very large. **Perimeters** can create partitions within a workspace to help you manage the resources. You can create perimeters to separate resources by team, environment, or any other criteria that makes sense for your organization.

As identities are grouped by [groups](/docs/resources/owl-workspace/owl-access/groups), you can group resources inside perimeters.
...
A [right](/docs/resources/owl-workspace/owl-access/rights) is an action applied to a perimeter.
