...
As identities are grouped by [groups](/docs/resources/owl-access/groups), you can group resources inside perimeters.
...
A [right](/docs/resources/owl-access/rights) is an action applied to a perimeter.
