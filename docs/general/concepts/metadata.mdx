...
Metadata can also be used in the [database](/docs/resources/owl-database/introduction) resource to add additional information to the data. It can attach to models, objects or properties information about:
- Movement
