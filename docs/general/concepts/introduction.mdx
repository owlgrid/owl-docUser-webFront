...
An OwlGrid instance is called a [spaces](/docs/general/concepts/spaces). 
...
Inside a space, resources are organized in [perimeters](/docs/general/concepts/perimeters).
