...
Each [space](/docs/general/concepts/spaces) is related to an **organization**. An organization represents an entreprise, an association, etc. It is used to identify the context in wich (spaces) are used and to bill usage.
