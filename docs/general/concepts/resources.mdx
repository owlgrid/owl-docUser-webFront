...
The amount of resources included in a [space](/docs/general/concepts/spaces) can be very large. **Perimeters** can create partitions within a space to help you manage the resources. You can create perimeters to separate resources by team, environment, or any other criteria that makes sense for your organization.

As identities are grouped by (groups)[/docs/resources/access/groups], you can group resources inside perimeters.
...
A [right](/docs/resources/access/rights) is an action applied to a perimeter.
