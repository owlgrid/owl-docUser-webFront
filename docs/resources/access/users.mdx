...
La ressource de gestion des identités ne s'applique qu'à l'administration d'OwlGrid. Elle n'est pas utilisée par les applications. Les applications doivent utiliser leur propre système de gestion des utilisateurs. Pour plus d'informations, consulter la section [Users templates](/docs/templates/users).
